    ...
    while True:
        ...
        if len(jogadores) != 2:
            ...
            while gameover == 0:
                ...
                elif jogadores[estaJogando].bn.qtdJogadas == 0 and jogadores[estaParado].bn.qtdJogadas == 0:
                ...
                elif jogadores[estaParado].bn.qtdJogadas == 0:
                    text = "0"
                    data = text.encode(ENCODE)  # Codifica para BASE64 os dados
                    sock.sendto(data, jogadores[estaJogando].address)  # Enviando dados
...
class ThreadTratador(threading.Thread):
    ...
    def __init__(self, a, b):
        ...
        self.sock = a
        self.address = b
        self.bn = BattleShip.batalhaNaval()
